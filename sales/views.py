...
def phone_exchange_list(request):
    ...
    return render(request, 'sales/phone_exchange_list.html', {'phone_exchanges': phone_exchanges})
...
def expense_create(request):
    ...
    return render(request, 'sales/expense_form.html', {'form': form, 'title': 'Xarajat yaratish'})
...
def expense_edit(request, pk):
    ...
    return render(request, 'sales/expense_form.html', {'form': form, 'title': 'Xarajatni tahrirlash'})
...
def expense_delete(request, pk):
    ...
    return render(request, 'sales/confirm_delete.html', {'object': expense, 'title': 'Xarajatni o\'chirish'})
