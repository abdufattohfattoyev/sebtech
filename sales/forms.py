...
# sales/forms.py - TO'G'IRLANGAN VERSIYA
from datetime import timedelta
from django import forms
from django.core.exceptions import ValidationError
from django.utils import timezone
...
class PhoneSaleForm(forms.ModelForm):
    ...
    def save(self, commit=True):
        ...
        is_new = not self.instance.pk  # ✅ Yangi yoki edit ekanligini aniqlash
        ...
        if commit:
            ...
            # ✅ IKKI TOMONLAMA QARZ YARATISH (faqat yangi sotuvda)
            if is_new and phone_sale.debt_amount > 0:
