...
class Supplier(models.Model):
    ...
    # ✅ YANGI - Boshlang'ich qarz (telefonga bog'liq emas)
    initial_debt = models.DecimalField(
        max_digits=12,
        decimal_places=2,
        default=0,
        verbose_name="Boshlang'ich qarz ($)",
        help_text="Tizimga kiritishdan oldingi qarz"
    )

    # Qarz maydonlari (telefonlarga bog'liq)
    total_debt = models.DecimalField(
        max_digits=12,
        decimal_places=2,
        default=0,
        verbose_name="Telefonlar qarzi ($)",
        help_text="Telefon olishlardan kelib chiqqan qarz"
    )
    ...
    @property
    def balance(self):
        """Qoldiq qarz = Boshlang'ich qarz + Telefonlar qarzi"""
        return self.initial_debt + self.total_debt

    def update_total_debt(self):
        """Taminotchining telefonlar qarzini hisoblash"""
